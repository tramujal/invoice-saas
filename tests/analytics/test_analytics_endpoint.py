...
def test_requires_authentication(client, db_session):
    org = make_org_with_owner_on_plan(db_session, analytics_enabled=True, forecasting_enabled=True, email="kpi-auth@example.com")
...
def test_foreign_user_cannot_read_kpis(client, db_session):
    org_a = make_org_with_owner_on_plan(db_session, analytics_enabled=True, forecasting_enabled=True, email="kpi-tenant-a@example.com")
    org_b = make_org_with_owner_on_plan(db_session, analytics_enabled=True, forecasting_enabled=True, email="kpi-tenant-b@example.com")
...
def test_returns_kpi_snapshot_for_default_window(client, db_session):
    org = make_org_with_owner_on_plan(db_session, analytics_enabled=True, forecasting_enabled=True, email="kpi-default@example.com")
...
def test_accepts_a_different_window_kind(client, db_session):
    org = make_org_with_owner_on_plan(db_session, analytics_enabled=True, forecasting_enabled=True, email="kpi-window@example.com")
...
def test_rejects_unsupported_custom_window(client, db_session):
    org = make_org_with_owner_on_plan(db_session, analytics_enabled=True, forecasting_enabled=True, email="kpi-custom@example.com")
...
def test_rejects_unknown_window_value(client, db_session):
    org = make_org_with_owner_on_plan(db_session, analytics_enabled=True, forecasting_enabled=True, email="kpi-invalid@example.com")
