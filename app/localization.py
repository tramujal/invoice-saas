...
_TRANSLATIONS: dict[str, dict[str, str]] = {
    "en": {
        ...
        # Phase 28 -- a 0% tax group is "Exempt", never "Tax 0%".
        "tax_exempt_label": "Exempt",
        "notif_credit_note_kind": "Credit note",
        "notif_debit_note_kind": "Debit note",
        "notif_adjustment_note_created_title": "{kind} created",
        "notif_adjustment_note_created_body": "{note_number} was created as a draft.",
        "notif_adjustment_note_issued_title": "{kind} issued",
        "notif_adjustment_note_issued_body": "{note_number} was issued for {currency} {total}.",
        "notif_adjustment_note_voided_title": "{kind} voided",
        "notif_adjustment_note_voided_body": "{note_number} was voided and no longer affects the invoice.",
        "notif_adjustment_note_sent_title": "{kind} sent",
        "notif_adjustment_note_sent_body": "{note_number} was emailed to the customer.",
        "credit_note_title": "CREDIT NOTE",
        "debit_note_title": "DEBIT NOTE",
        "note_no_label": "Note #",
        "related_invoice_label": "Related invoice",
        "note_reason_label": "Reason",
        "note_email_body": "Attached is {note_number} from {organization}.",
        "tax_base_label": "base",
        "total_label": "Total",
    ...
    "es": {
        ...
        "tax_exempt_label": "Exento",
        "notif_credit_note_kind": "Nota de cr\u00e9dito",
        "notif_debit_note_kind": "Nota de d\u00e9bito",
        "notif_adjustment_note_created_title": "{kind} creada",
        "notif_adjustment_note_created_body": "Se cre\u00f3 {note_number} como borrador.",
        "notif_adjustment_note_issued_title": "{kind} emitida",
        "notif_adjustment_note_issued_body": "Se emiti\u00f3 {note_number} por {currency} {total}.",
        "notif_adjustment_note_voided_title": "{kind} anulada",
        "notif_adjustment_note_voided_body": "Se anul\u00f3 {note_number} y ya no afecta la factura.",
        "notif_adjustment_note_sent_title": "{kind} enviada",
        "notif_adjustment_note_sent_body": "Se envi\u00f3 {note_number} por correo al cliente.",
        "credit_note_title": "NOTA DE CR\u00c9DITO",
        "debit_note_title": "NOTA DE D\u00c9BITO",
        "note_no_label": "Nota N\u00b0",
        "related_invoice_label": "Factura relacionada",
        "note_reason_label": "Motivo",
        "note_email_body": "Adjunto encontrar\u00e1s {note_number} de {organization}.",
        "tax_base_label": "base",
        "total_label": "Total",
